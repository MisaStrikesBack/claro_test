...
from utils.constants import POKEAPI_URL
# from endpoints.pokemon import pokemon_endpoint

# inicializando el app de flask
app = Flask(__name__)


# definiendo el endpoint en un solo método con decoradores
# para la lista y para el detalle
@app.route(
    '/api/pokemon',
    defaults={'pokemon_id': None},
    methods=['GET'])
@app.route(
    # aseguramos que el parámetro sea un valor entero,
    # de lo contrario el servicio regresa un 404
    '/api/pokemon/<int:pokemon_id>',
    methods=['GET'])
